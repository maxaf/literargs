...
/**
 * Local fork of default parser.
 * Obtained from: http://svn.apache.org/repos/asf/commons/proper/cli/tags/cli-1.3.1/src/main/java/org/apache/commons/cli/DefaultParser.java
 *
 * @version $Id$
 * @since 1.3
 */
public class LenientParser implements CommandLineParser
{
    ...
    /**
     * Handles an unknown token by doing nothing.
     *
     * @param token the command line token to handle
     */
    ...
    protected void handleConcatenatedOptions(String token) throws ParseException
    {
        for (int i = 1; i < token.length(); i++)
        {
            ...
            {
                handleUnknownToken(true /* stopAtNonOption */ && i > 1 ? token.substring(i) : token);
                break;
            }
        }
    }
